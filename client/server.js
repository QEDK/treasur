...
app.post('/mint', async (req, res) => {
  try {
    ...
    const rv = await TreasurContract.methods.approveMint(req.tokenUri, req.tokenURIStr, req.tokenCreator).send({"from": "0xd1058ECCEE8102Bb8C1A7390b7d6Ea2CB6dA8E0e"})
    res.send(rv);
  } catch (e) {
    console.log('This request is fucking up')
  }
